...
GENERATED_SET = EvaluationHvoDataset(EVALUATION_SET_PATH)
EVALUATION_SET = EvaluationHvoDataset(EVALUATION_SET_PATH)

def test_relative_comparison():

    print(len(GENERATED_SET))
    comparison_results_by_feat = relative_comparison(GENERATED_SET, EVALUATION_SET)
...
def test_relative_comparison_simple():
    print(len(GENERATED_SET))
    comparison_results_by_feat = relative_comparison(GENERATED_SET, EVALUATION_SET, simple=True)
